...
if (isset($_POST["id"]) && !empty($_POST["id"])) {
    ...
    $sql = "DELETE FROM foodoritemdonationstatus WHERE id = ?";
    ...
    if (empty(trim($_GET["id"]))) {
        ...
        header("location: admindonationstatusserror.php");
        exit();
    }
}
?>
                ...
                <div class="signup_form">
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <b>
                                <p>Are you sure you want to Delete this donation status ?</p>
                            </b>
                            <p>
                        ...
                        <a href="adminviewdispatchstatus.php" class="btn btn-default">No</a>
                    </form>
