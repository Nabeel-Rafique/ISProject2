...
<h1 class="heading mb-3">Sign Up As A Relief Organization</h1>
...
<div class="col-mb-3 mx-auto text-center text-lg-left">
                ...
                <div class="signup_form">
                    <form action="hosignup.php" method="POST">
                        ...
                        <br>
                       <br>
                        <div class="link login-link text-center">Already have an Account?<a href="hologin.php">  Login here</a></div>
                        <br>
                        <br>
                    </form>
