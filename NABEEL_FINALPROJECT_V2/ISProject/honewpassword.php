...
<body>
    ...
    <div class="py-3">
        <h2 style="font-size: 50px; text-align: center;">Relief Organization Reset Code</a></h2>
        ...
        <div class="col-sm-4">
            ...
            <div class="col-sm-4">
                ...
                <div class="signup_form">
                    <form action="honewpassword.php" method="POST">
                        ...
                        <button type="submit" name="change-password" value="Submit" class="btn btn-outline-success form_btn">Submit</button>
