...
if (isset($_POST['signup'])) {
    ...
    if (count($errors) === 0) {
        ...
        $status = "notverified";
        $insert_data = "INSERT INTO admintable (name, email, password, code, status)
...
if (isset($_POST['login'])) {
    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        $errors['email'] = "It's look like you are not yet an admin! Please Contact Administration Help Desk";
...
if (isset($_POST['change-password'])) {
    ...
    if ($password !== $cpassword) {
        ...
        if ($run_query) {
            ...
            $_SESSION['info'] = $info;
            header('Location: adminpasswordchanged.php');
        } else {
