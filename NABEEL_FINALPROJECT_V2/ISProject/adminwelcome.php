                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Total Number of Food Donations Made</div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Subscribed Organizations
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                            ...
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Total Number of Articles Posted</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php
 require_once "mainconfig.php";
...
?></div>
                                ...
                                <?php  
  require_once "mainconfig.php";
 $query = "SELECT foodlocation, count(*) as number FROM fooddonation GROUP BY foodlocation";  
 ...
 ?>  
           ...
           {  
                var data = google.visualization.arrayToDataTable([  
                          ...
                          {  
                               echo "['".$row["foodlocation"]."', ".$row["number"]."],";  
                          }  
                          ?>  
                     ]);  
                var options = {  
      ...
      <body>  
           ...
           <div style="width:500px;">  
                <h3 align="center">Distribution of Food Donations Made In Kenya</h3>  
                <br />  
