...
<div class="col-mb-3 mx-auto text-center text-lg-left">
                ...
                <div class="signup_form">
                    <form action="dispatchlogin.php" method="POST">
                        ...
                        <div class="link forget-pass text-center"> Forgot password?<a href="dispatchforgotpassword.php"> <br>Click here</a></div>

                        <br>

                        <div class="link login-link text-center">Not yet a member? <a href="dispatchsignup.php"><br>Sign Up now</a></div>
<br>
                    </form>
