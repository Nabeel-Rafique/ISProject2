...
<h1 class="heading mb-3">Dispatch New Password</h1>
...
<div class="col-mb-3 mx-auto text-center text-lg-left">
                ...
                <div class="signup_form">
                    <form action="dispatchnewpassword.php" method="POST">
                        ...
                        <button type="submit" name="change-password" value="Submit" class="btn btn-primary">Submit</button>
                        <br>
                        <br>
                    </form>
                </div>
