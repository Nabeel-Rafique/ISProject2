...
<h1 class="heading mb-3">Sign Up As A Donor</h1>
...
<div class="col-mb-3 mx-auto text-center text-lg-left">
                ...
                <div class="signup_form">
                    <form action="donorsignup.php" method="POST">
                        ...
                        <input class="form-control" type="text" name="name" placeholder="First Name" required value="<?php echo $name ?>">
                        ...
                        <input class="form-control" type="text" name="l_name" placeholder="Last Name" required value="<?php echo $l_name ?>">
                        ...
                        <br>
                       <br>
                        <div class="link login-link text-center">Already have an Account?<a href="donorlogin.php">  Login here</a></div>
                        <br>
                        <br>
                    </form>
