...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="viewdonorfooddonations.php">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Welcome Dispatch Unit: <?php echo $fetch_info['name'] ?></h1>
                        <a href="d_vfood_pdf.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
                    </div>
                    ...
                    <section class="p-t-20">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <h3 class="title-5 m-b-35">Donor Food Donation Details</h3>
                                    ...
                                    if ($result = mysqli_query($con, $sql)) {
                                        if (mysqli_num_rows($result) > 0) {
                                            ...
                                            while ($row = mysqli_fetch_array($result)) {
                                                ...
                                                echo "<td> <img id='campaignimage' src='" . $row['foodimage'] . "'/> </td>";
                                                echo "<td>" . $row['fooddescription'] . "</td>";
                                                echo "<td>" . $row['foodlocation'] . "</td>";
                                                ...
                                                echo "<a href='fooddonationstatus.php?id=" . $row['donorid'] . "' class='item' title='Edit' data-toggle='tooltip' data-placement='top'><i class='zmdi zmdi-mail-send'></i></a>";
                                                echo "</div>";
