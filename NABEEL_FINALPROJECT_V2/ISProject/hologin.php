...
<h1 class="heading mb-3">Organization Login</h1>
...
<div class="col-mb-3 mx-auto text-center text-lg-left">
                ...
                <div class="signup_form">
                    <form action="hosignup.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <label class="label_txt">Organization's Email</label>
                        ...
                        <div class="link forget-pass text-center"> Forgot password?<a href="hoforgotpassword.php"> <br>Click here</a></div>

                        <br>

                        <div class="link login-link text-center">Not yet a member? <a href="hosignup.php"><br>Sign Up now</a></div>
<br>
                    </form>
