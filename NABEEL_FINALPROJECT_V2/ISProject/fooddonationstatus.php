...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="aiditemdonationstatus.php">
        ...
        <div class="py-3">
        <h3 style="font-size: 30px; text-align: center;">Enter the status of The Food donation Below</a></h3>
