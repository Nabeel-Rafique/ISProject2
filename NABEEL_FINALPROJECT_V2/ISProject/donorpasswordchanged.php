...
<h1 class="heading mb-3">Password Changed!</h1>
...
<div class="col-mb-3 mx-auto text-center text-lg-left">
                ...
                <div class="signup_form">
                    <form action="donorpasswordchanged.php" method="POST">
                        ...
                        <button type="submit" name="login-now" value="Login Now" class="btn btn-primary">Login Now</button>
