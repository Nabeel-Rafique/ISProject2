...
<div class="col-mb-3 mx-auto text-center text-lg-left">
                ...
                <div class="signup_form">
                    <form action="dispatchforgotpassword.php" method="POST">
                        ...
                        <button type="submit" name="check-email" value="Continue" class="btn btn-primary">Login</button>
                        <a href="dispatchlogin.php" class="btn btn-outline-success"> Back </a>
