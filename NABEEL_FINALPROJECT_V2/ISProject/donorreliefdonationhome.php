...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="donorreliefdonationhome.php">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="d_rdonation_pdf.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
                    </div>
                    ...
                    <section class="p-t-20">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <h3 class="title-5 m-b-35">Donation Relief Details</h3>
                                    ...
                                    if ($result = mysqli_query($con, $sql)) {
                                        if (mysqli_num_rows($result) > 0) {
                                            ...
                                            echo "<tr>";
                                            echo "<th>No</th>";
                                            echo "<th>Relief-Item Name</th>";
                                            echo "<th>Relief-Item Image</th>";
                                            echo "<th>Relief-Item Description</th>";
                                            echo "<th>Location</th>";
                                            echo "<th> Relief-Item Quantity</th>";
                                            echo "<th>Relief-Item Status</th>";
                                            //echo "<th>Action</th>";
                                            echo "</tr>";
                                            echo "</thead>";
                                            echo "<tbody>";
                                            ...
                                            while ($row = mysqli_fetch_array($result)) {
                                                ...
                                                echo "<td> <img id='campaignimage' src='" . $row['itemimage'] . "'/> </td>";
                                                ...
                                                //  echo "<a  href='admindonordonationsupdate.php?id=" . $row['id'] . "' class='item' title='Edit' data-toggle='tooltip' data-placement='top'><i class='zmdi zmdi-edit'></i></a>";
                                                //   echo "<a href='admindonordonationsdelete.php?id=" . $row['id'] . "' class='item' title='Edit' data-toggle='tooltip' data-placement='top'><i class='zmdi zmdi-delete'></i></a>";
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a class="btn btn-secondary" href="donorlogout.php">Log Out<span class="sr-only">(current)</span></a>
                            </div>
                        </div>
                    </div>
                </div>
