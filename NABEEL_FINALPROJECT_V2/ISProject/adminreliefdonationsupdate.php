...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($itemname_err) && empty($itemimage_err) && empty($itemdescription_err) && empty($location_err) && empty($itemquantity_err) && empty($itemstatus_err)) {
        ...
        $sql = "UPDATE Aiddonations SET itemname=?,itemimage=?,itemdescription=?,location=?,itemquantity=?,itemstatus=?   WHERE id=?";
        ...
        if ($stmt = mysqli_prepare($con, $sql)) {
            ...
            mysqli_stmt_bind_param($stmt, "ssssssi", $param_itemname, $param_itemimage, $param_itemdescription, $param_location, $param_itemquantity, $param_itemstatus, $_SESSION['edit_id']);
...
<body id="page-top">
    ...
    <div class="container">
    <div class="py-2">
        <h2 style="text-align: center;">Update Details of the Items Donated by the donor Below</h3>
            ...
            <div class="signup_form">
                    <form action="" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="form-group">
                            <button type="submit" name="donate" value="Donate" class="btn btn-outline-success form_btn">Submit</button>
                        </div>
                        </div>
                        <a href="adminviewreliefdonations.php" class="btn btn-default">Cancel</a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; NabeelRafique 2020</span>
                    </div>
