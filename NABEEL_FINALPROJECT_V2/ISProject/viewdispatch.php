...
<?php include 'adminmenu.php' ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="dispatch_pdf.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
        ...
        <section class="p-t-20">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="title-5 m-b-35">Subscribed Dispatch Units</h3>
                        ...
                        if ($result = mysqli_query($con, $sql)) {
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                echo "<tr>";
                                echo "<th>No</th>";
                                echo "<th>Dispatch Unit Name</th>";
                                echo "<th>Dispatch Unit Email</th>";
                                echo "<th>Status</th>";
                                echo "<th>Action</th>";
                                echo "</tr>";
                                echo "</thead>";
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    echo "<a  href='adminaiddonationsupdate.php?id=" . $row['id'] . "' class='item' title='Edit' data-toggle='tooltip' data-placement='top'><i class='zmdi zmdi-edit'></i></a>";
                                    echo "<a href='adminaiddonationsdelete.php?id=" . $row['id'] . "' class='item' title='Delete' data-toggle='tooltip' data-placement='top'><i class='zmdi zmdi-delete'></i></a>";
