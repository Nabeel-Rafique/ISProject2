...
<h1 class="heading mb-3">Donor Login</h1>
...
<div class="col-mb-3 mx-auto text-center text-lg-left">
                ...
                <div class="signup_form">
                    <form action="donorlogin.php" method="POST">
                        ...
                        <button type="submit" name="login" value="Login" class="btn btn btn-primary">Login</button>
                       
                        <br>
                       
                        <div class="link forget-pass text-center"> Forgot password?<a href="donorforgotpassword.php"> <br>Click here</a></div>

                        <br>

                        <div class="link login-link text-center">Not yet a member? <a href="donorsignup.php"><br>Sign Up now</a></div>
<br>
                    </form>
